...
class ScenariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scenario" do
    assert_difference('Scenario.count') do
      post scenarios_url, params: { scenario: { name: @scenario.name, test: @scenario.test } }
    end
  ...
  test "should update scenario" do
    patch scenario_url(@scenario), params: { scenario: { name: @scenario.name, test: @scenario.test } }
